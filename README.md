...
| Tab          | What it does                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Today**    | A wrist watch's dial with time worked, breaks and kinds of work drawn on it as one ring, the day's share of its target filling the bezel clockwise and overshooting in the flag colour past it, and a light behind the case that beats while you are working. The face is the switch: press it to start working and again to stop. Round it, the buttons: one per break type, one chip per kind of work, and **Custom** for a kind you have not set up; on a desk they stand either side of the dial. Press a stretch of the ring, or a break's end printed on the rim, to open the day stretch by stretch and move an end; press the line under the dial to correct when you started. Under a mouse, resting on the ring reads a stretch's name and times, and the right button opens everything the day can do. |
...
| **Projects** | One card per project: a pill per working day, weekends apart, and the day's length. Edit and delete are the two glyphs top right. Add a project, and — once there are two — choose which is **in use**; the top bar then grows a switcher.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
