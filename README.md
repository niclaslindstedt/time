...
| **Projects** | One card per project with its working days, day length, break types and kinds of work. Each break type and kind of work carries a mark, picked from fifty-two — weighted towards work done at a computer — and a kind of work carries one of eight colours, which it then wears on the clock, on its chip and in the report. Add, edit, delete, and — once there are two — choose which is **in use**; the top bar then grows a switcher.                                                                                                                                                                                                                                                                                                                                                                                                                                  |
