...
| Button | What it does                                                                                                                                                                                                                                                          |
| ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **⚙**  | Settings: theme, the watch dial (nine presets or a custom face, markers, numerals, ring, hands, size and movement), the backlight behind it (colour, beat, brightness and spread), week start, cloud sync, backup / restore / delete, developer tools, and the build. |
