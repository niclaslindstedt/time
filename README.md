...
still counts as work, the kinds of work with their marks and colours — and
the mark and colour the project itself wears. One project is the default and
the app never asks which; register a second and its mark appears in the top
left corner, which is the switcher.
...
| **Report**   | A week or a month, opening on two rings: the range's share of its target, filling clockwise and overshooting in the flag colour past it, and its balance, red when short and green when ahead — each with its pair of figures under it, worked and target, balance and the running balance since your first day. Under them, the week as a column per day, where the target is the track and the hours worked fill it from the floor and carry on past the top when the day ran long; the month as a calendar of boxes, a row to the week and a box to the day; where the hours went by kind of work; break time by kind. **…** beside the range exports it as a PDF specification to send with an invoice — six built-in styles or one of your own, the hours at whatever grain you choose, optional rounding up to the next 5 to 60 minutes a day, and either a download or a print — or as a file for the [Invoice](https://github.com/niclaslindstedt/invoice) app, which drops onto a draft there as lines.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Projects** | One card per project: its own mark in its own colour, a pill per working day, weekends apart, and the day's length. Edit and delete are the two glyphs top right. The editor names the break types and kinds of work, says how much of each kind of break still counts as work — none of it, all of it, or the first so many minutes a day — stars the ones that get a button of their own on **Today** — and gives each a mark from its own vocabulary — the day's pauses for a break type, work's for a kind of work, and the neutral marks to both — with one of eight colours for a kind of work, which it then wears on the clock, on its chip and in the report. It also gives the project itself a mark and a colour — what it wears in the top left corner, in the switcher and on its card. Add a project, and — once there are two — choose which is **in use**; the project's mark then appears in the top left corner of every screen, and pressing it lists the projects to switch between.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
